...
val make_block : ?phis:instr list -> ?span:Span.t -> label -> instr list -> terminator -> block
val make_func :
  id:fn_id -> name:Ident.t -> params:vreg list ->
  ?param_tys:typ list -> ?ret_ty:typ -> blocks:block list -> entry:label ->
  ?n_vregs:int -> ?is_main:bool -> ?span:Span.t -> unit -> func
val make_program : ?string_table:string list -> functions:func list -> main:fn_id -> program
